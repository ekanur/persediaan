...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Persediaan Barang Simbois FS</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">SIMBOIS FS</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 - <a href="www.sastra.um.ac.id">Fakultas Sastra Universitas Negeri Malang</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
